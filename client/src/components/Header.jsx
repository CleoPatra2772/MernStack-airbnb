...
const Header = () => {
  ...
  <path stroke-linecap="round" strokeLinejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" />
        ...
        <div>Anywhere</div>
        <div className='boder border-l border-gray-300'></div>
        <div className='gap-2'>Any week</div>
        <div className='boder border-l border-gray-300'></div>
        <div className='gap-2'>Add guests</div>
        <button className='bg-primary text-white p-1 rounded-full'>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" clasName="w-4 h-4">
